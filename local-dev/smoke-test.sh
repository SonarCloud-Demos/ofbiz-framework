...
curl --fail --silent --show-error "$catalog_url/actuator/health/readiness" | rg -q '"status":"UP"'
...
curl --fail --silent --show-error --head "$route_url/catalog/products" | rg -qi '^X-Application-Generation: hybrid'
...
echo 'Modern paved-road and Phase 2/3 edge smoke checks passed.'
